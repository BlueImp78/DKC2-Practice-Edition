...
;	$42,x = bonus type
;	$46,x = time
;	$4A,x = pointer to second digit sprite
...
CODE_B3DCF0:
	...
	STZ $2E,x				;$B3DCFB   |
CODE_B3DCFD:					;	   |
;START OF PATCH		(turn on is_bonus flag on bonus timer)
	LDA #$0001
...
;START OF PATCH			;dont increase bonus song tempo
	BRA CODE_B3DDA7
;END OF PATCH
...
;timer digit graphics table? for $1A,x
DATA_B3DE2C:
...
;START OF PATCH		(preserve lui timer values and player status on checkpoint)
	LDA !lv_sel_toggle
	BEQ .done
