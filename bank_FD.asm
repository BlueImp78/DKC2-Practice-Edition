...
;START OF PATCH		(include new palettes)
level_select_sprite_pal_dark_full:
	incbin "level_select/data/sprite_pal_dark_full.bin"

level_select_sprite_pal_dark:
	incbin "level_select/data/sprite_pal_dark.bin"

level_select_sprite_pal_bright:
	incbin "level_select/data/sprite_pal_bright.bin"

level_select_bg1_pal_dark_full:
	incbin "level_select/data/bg1_pal_dark_full.bin"

level_select_bg1_pal_bright:
	incbin "level_select/data/bg1_pal_bright.bin"

level_select_bg1_pal_dark:
	incbin "level_select/data/bg1_pal_dark.bin"

level_select_bg2_pal:
	incbin "level_select/data/bg2_dark_pal.bin"

level_select_p1_palette:
	incbin "level_select/data/p1_icon_palette.bin"

level_select_p2_palette:
	incbin "level_select/data/p2_icon_palette.bin"
;END OF PATCH
