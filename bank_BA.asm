...
;START OF PATCH		(mute music if silence selected in jukebox)
	JSL mute_music
;END OF PATCH
...
incsrc "level_select/code/level_select_data.asm"
incsrc "level_select/code/level_select_text_data.asm"
print pc
